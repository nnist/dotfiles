...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Courier Prime Sans"
                               :size 11.0
                               :weight normal
                               :width normal)
...
before packages are loaded."
  ...
  (with-eval-after-load 'org
    ...
    (setq org-todo-keywords
      (quote
       ((sequence "TODO" "NEXT" "DOING" "DELEGATED" "WAIT" "SOMEDAY" "|" "DONE" "CANCELED"))))
    (setq org-todo-keyword-faces
          '(("TODO" . "#dc322f") ("NEXT" . "#6c71c4") ("DOING" . "#268bd2") ("DELEGATED" . "#93a1a1") ("WAIT" . "#93a1a1") ("SOMEDAY" . "#93a1a1") ("DONE" . "#93a1a1") ("CANCELED" . "#93a1a1")))
    ...
    (custom-theme-set-faces
     ...
     '(org-headline-done ((t (:foreground "#839496"))))
     '(org-date ((t (:height 0.9 :foreground "#d33682" :underline t :weight normal))))
     '(org-table ((t (:foreground "#83a598"))))
     '(org-tag ((t (:inherit (shadow) :weight bold :height 0.8))))
     '(org-link ((t (:foreground "#268bd2" :underline t :weight normal :height 1.0))))
     '(org-verbatim ((t (:inherit (shadow)))))
     '(org-checkbox ((t (:background "#eee8d5" :foreground "#657b83" :box nil :weight bold))))
     '(org-done ((t (:foreground "#93a1a1" :weight normal :height 1.0))))
     '(org-todo ((t (:foreground "#dc322f" :weight normal :height 1.0))))
     '(org-superstar-header-bullet ((t (:height 0.9))))
     '(org-superstar-leading ((t (:foreground "#eee8d5" :height 1.2))))
     )

    ;; Custom fonts
    (let* ((variable-tuple
            (cond ((x-list-fonts "Courier Prime Sans")     '(:font "Courier Prime Sans"))
                  (nil (warn "Cannot find a Sans Serif Font."))))
           (base-font-color     (face-foreground 'default nil 'default))
           (headline           `(:inherit default :weight bold :foreground "#586e75")))
